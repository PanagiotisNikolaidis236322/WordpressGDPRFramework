...
// Initialize variables with proper type checks
$settings = $settings ?? null;
$access_manager = $access_manager ?? null;
$portability = $portability ?? null;
$encryption = $encryption ?? null;
$gdpr = $gdpr ?? null;

// Get and validate consent types
            ...
            <div class="consent-type-item">
                <div class="consent-type-header">
                    <input type="text"
                           ...
                           class="regular-text"
                           placeholder="<?php esc_attr_e('Consent Type Label', 'wp-gdpr-framework'); ?>"
                           required>
                ...
                <textarea name="gdpr_consent_types[<?php echo esc_attr($key); ?>][description]"
                          class="large-text"
                          placeholder="<?php esc_attr_e('Description', 'wp-gdpr-framework'); ?>"
